...
class TrkDatatablesActiveRecordTest < Minitest::Test
  ...
  def test_order_items_by_two_columns
    ...
    assert_equal_with_message [first, second, third],
      posts_dt(:order_and_paginate_items, order: {0 => {column: 0, dir: "asc"}}), :title

    assert_equal_with_message [third, first, second],
      posts_dt(:order_and_paginate_items, order: {0 => {column: 3, dir: "desc"}, 1 => {column: 0, dir: "asc"}}), :title
  end
  ...
  def test_filter_by_columns_one_string_one_column
    ...
    assert_equal_with_message [post1a],
      posts_dt(:filter_by_columns, columns: {"0": {searchable: true, search: {value: "1a_post"}}}), :title
    assert_equal_with_message [post1b, post2],
      posts_dt(:filter_by_columns, columns: {"1": {searchable: true, search: {value: "2021-01-01"}}}), :title
  end
  ...
  def test_filter_by_columns_two_strings_two_columns
    ...
    assert_equal_with_message [post1a, post2a],
      posts_dt(:filter_by_columns, columns: {"0": {searchable: true, search: {value: "a_post post"}}}), :title
    assert_equal_with_message [post1b, post2a, post2b],
      posts_dt(:filter_by_columns, columns: {"0": {}, "1": {searchable: true, search: {value: "20 03"}}}), :title
    # intersection of two previous queries
    assert_equal_with_message [post2a],
      posts_dt(:filter_by_columns, columns: {"0": {searchable: true, search: {value: "a_post post"}}, "1": {searchable: true, search: {value: "20 03"}}}), :title
  end
  ...
  def test_filter_column_between_integer_and_float
    ...
    # integer
    assert_equal_with_message [post1b, post2a],
      posts_dt(:filter_by_columns, columns: {"2": {searchable: true, search: {value: "1#{TrkDatatables::BETWEEN_SEPARATOR}2"}}}), :title
    assert_equal_with_message [post1a, post1b, post2a],
      posts_dt(:filter_by_columns, columns: {"2": {searchable: true, search: {value: " #{TrkDatatables::BETWEEN_SEPARATOR}2"}}}), :title
    assert_equal_with_message [post2a, post2b],
      posts_dt(:filter_by_columns, columns: {"2": {searchable: true, search: {value: "2#{TrkDatatables::BETWEEN_SEPARATOR}"}}}), :title
    assert_equal_with_message [post1a, post1b, post2a, post2b],
      posts_dt(:filter_by_columns, columns: {"2": {searchable: true, search: {value: " #{TrkDatatables::BETWEEN_SEPARATOR}  "}}}), :title

    # float
    assert_equal_with_message [post2a, post2b],
      posts_dt(:filter_by_columns, columns: {"4": {searchable: true, search: {value: "1.15#{TrkDatatables::BETWEEN_SEPARATOR}1.2"}}}), :title

    # integer and float without separator
    assert_equal_with_message [post1a, post1b],
      posts_dt(:filter_by_columns, columns: {"2": {searchable: true, search: {value: "#{TrkDatatables::BETWEEN_SEPARATOR}1"}}, "4": {searchable: true, search: {value: ".1"}}}), :title

    # invalid format
    assert_equal_with_message Post.all.to_a,
      posts_dt(:filter_by_columns, columns: {"2": {searchable: true, search: {value: " #{TrkDatatables::BETWEEN_SEPARATOR}a2"}}}), :title
  end
  ...
  def test_filter_column_between_date_and_datetime
    Time.use_zone("Belgrade") do
      ...
      # date
      assert_equal_with_message [post1b, post2a],
        posts_dt(:filter_by_columns, columns: {"1": {searchable: true, search: {value: "2020-01-15#{TrkDatatables::BETWEEN_SEPARATOR}2020-03-02"}}}), :published_on
      assert_equal_with_message [post2a, post2b],
        posts_dt(:filter_by_columns, columns: {"1": {searchable: true, search: {value: "2020-03-01#{TrkDatatables::BETWEEN_SEPARATOR}"}}}), :published_on

      # datetime
      assert_equal [post1a, post1b],
        posts_dt(:filter_by_columns, columns: {"5": {searchable: true, search: {value: "2010-01-01 07:00:00#{TrkDatatables::BETWEEN_SEPARATOR}2010-01-01 07:00:00"}}}), "it should match #{post1a.user.registered_at} #{post1b.user.registered_at}"
      ...
      assert_equal_with_message [post1b],
        posts_dt(:filter_by_columns, columns: {"1": {searchable: true, search: {value: "2020-02-01#{TrkDatatables::BETWEEN_SEPARATOR}"}}, "5": {searchable: true, search: {value: "#{TrkDatatables::BETWEEN_SEPARATOR}2010-01-01 07:00:00"}}}), :title
    end
  end
  ...
  def test_select_options
    ...
    datatable = MultiselectsDatatable.new TrkDatatables::DtParams.sample_view_params columns: {"0": {searchable: true,
                                                                                                     search: {value: "published|promoted"}}}
  ...
  def test_parse_from_to_dates
    ...
    assert_equal ["2000-01-01 00:00:00", "2000-01-02 23:59:59"], (datatable._parse_from_to(from, to, column_key_option).map do |t|
